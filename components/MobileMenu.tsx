...
export default function MobileMenu() {
  ...
  return (
    <div className={`flex`}>
      ...
      <nav
        className={`w-[77.5%] h-[100vh] fixed z-40 top-0 right-0 bg-pink-300 flex flex-col items-center justify-center animate-duration-300 border-l-2 border-pink-400 ${
          isMobileMenuOpen ? 'animate-fade-left' : 'animate-fade-right'
        }`}
      >
        <div className="flex justify-center items-center gap-16">
          <img src="/ganko.webp" alt="ganko image" className="h-[5rem]" />
          <img src="/bulmaPng.png" alt="bulma image" className="h-[4rem]" />
        </div>
