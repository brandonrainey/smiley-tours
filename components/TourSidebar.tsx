...
export default function TourSidebar({ tours }: TourSidebarProps) {
  return (
    <div className="bg-pink-200 h-[1000px] w-80 relative p-4">
      <Image src='/bulma.png' width={100} height={72} alt='bulma image' className='absolute -top-12 -left-10'/>
      <h1 className='text-center text-4xl font-bold mb-6 mt-4 text-white' style={{ textShadow: '4px 4px 8px rgba(243, 15, 133, 0.8)' }}>Tours</h1>
