...
export default function Header() {
  ...
  return (
    <header className="w-full flex justify-center items-center border-b-2 border-pink-600 custom:relative bg-pink-400 sticky top-0 custom:z-0 z-50 custom:mb-[30px]">
